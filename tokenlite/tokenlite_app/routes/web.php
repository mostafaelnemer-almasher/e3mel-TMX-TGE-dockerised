...
Route::prefix('user')->middleware(['auth', 'user', 'verify_user', 'g2fa'])->name('user.')->group(function () {
    ...
    Route::name('ajax.')->prefix('ajax')->group(function () {
        ...
        Route::post('/account/change-email', 'User\UserController@change_email_modal')->name('change.email');
        Route::post('/account/change-email/update', 'User\UserController@change_email_update')->name('change.email.update');
    });
});
...
Route::prefix('admin')->middleware(['auth', 'admin', 'verify_user', 'g2fa', 'ico'])->name('admin.')->group(function () {
    ...
    Route::get('/private/sale/invite', 'Admin\PrivateInvitationController@index')->middleware(['ico'])->name('private.invite.list');
    ...
    Route::name('ajax.')->prefix('ajax')->middleware(['ico'])->group(function () {
        ...
        Route::post('/users/wallet/action', 'Admin\UsersController@wallet_change_request_action')->name('users.wallet.action')->middleware('demo_user');
        ...
        Route::post('/stages/delete', 'Admin\IcoController@delete')->middleware('ico')->name('stages.delete')->middleware('demo_user');
        Route::post('/stages/archive', 'Admin\IcoController@archive')->middleware('ico')->name('stages.archive')->middleware('demo_user');
        ...
        Route::post('private/sale/invite/modal', 'Admin\PrivateInvitationController@modal_show')->name('private.invite.modal_show');
        Route::post('/private/sale/invite/update', 'Admin\PrivateInvitationController@update')->name('private.invite.update')->middleware('demo_user');
    });
