...
server {
    ...
    location ~ \.php\$ {
        ...
        fastcgi_pass tokenlite-app-${PROJECT_NAME}:9000;
    ...
    location ~* ^/installer/.+\.(css|js|png|jpg|jpeg|gif|ico|svg)\$ {
        expires 1y;
...
echo "Nginx configuration generated for project: ${PROJECT_NAME}"