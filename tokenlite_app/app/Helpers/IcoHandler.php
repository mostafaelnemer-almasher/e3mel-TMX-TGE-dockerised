...
class IcoHandler
{
    ...
    public static function checkDB()
    {
        ...
        $tables = ['activities', 'email_templates', 'global_metas', 'ico_metas', 'ico_stages', 'kycs', 'migrations', 'pages', 'password_resets', 'payment_methods', 'settings', 'transactions', 'users', 'user_metas', 'referrals', 'languages', 'translates', 'private_invitations'];
        $result = null;
        $return = null;
